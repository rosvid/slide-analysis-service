...
class RuleId(enum.Enum):
    ...
    LAYOUT_MAX_FONTS = _("The maximum number of fonts that can be used in presentations.")
    LAYOUT_MIN_FONT_SIZE = _("The minimum font size that can be used in presentations.")
